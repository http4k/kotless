...
resource "aws_api_gateway_base_path_mapping" "site" {
  ...
  stage_name = aws_api_gateway_deployment.http4k_site.stage_name
  domain_name = "http4k.site.kotless.io"
}

resource "aws_api_gateway_deployment" "http4k_site" {
...
resource "aws_api_gateway_domain_name" "site" {
  domain_name = "http4k.site.kotless.io"
  certificate_arn = data.aws_acm_certificate.http4k_site_kotless_io.arn
}
...
resource "aws_api_gateway_integration" "css_highlight_style_css" {
  ...
  type = "AWS"
  uri = "arn:aws:apigateway:${data.aws_region.current.name}:s3:path/${aws_s3_bucket_object.eu_http4k_site_s3_ktls_aws_intellij_net_static_css_highlight_style_css.bucket}/${aws_s3_bucket_object.eu_http4k_site_s3_ktls_aws_intellij_net_static_css_highlight_style_css.key}"
...
resource "aws_api_gateway_integration" "css_kotless_site_css" {
  ...
  integration_http_method = "GET"
  type = "AWS"
  uri = "arn:aws:apigateway:${data.aws_region.current.name}:s3:path/${aws_s3_bucket_object.eu_http4k_site_s3_ktls_aws_intellij_net_static_css_kotless_site_css.bucket}/${aws_s3_bucket_object.eu_http4k_site_s3_ktls_aws_intellij_net_static_css_kotless_site_css.key}"
  credentials = aws_iam_role.kotless_static_role.arn
}
...
resource "aws_api_gateway_integration" "favicon_apng" {
  ...
  integration_http_method = "GET"
  type = "AWS"
  uri = "arn:aws:apigateway:${data.aws_region.current.name}:s3:path/${aws_s3_bucket_object.eu_http4k_site_s3_ktls_aws_intellij_net_static_favicon_apng.bucket}/${aws_s3_bucket_object.eu_http4k_site_s3_ktls_aws_intellij_net_static_favicon_apng.key}"
  credentials = aws_iam_role.kotless_static_role.arn
}
...
resource "aws_api_gateway_integration" "js_highlight_pack_js" {
  ...
  integration_http_method = "GET"
  type = "AWS"
  uri = "arn:aws:apigateway:${data.aws_region.current.name}:s3:path/${aws_s3_bucket_object.eu_http4k_site_s3_ktls_aws_intellij_net_static_js_highlight_pack_js.bucket}/${aws_s3_bucket_object.eu_http4k_site_s3_ktls_aws_intellij_net_static_js_highlight_pack_js.key}"
  credentials = aws_iam_role.kotless_static_role.arn
}
...
resource "aws_cloudwatch_event_rule" "autowarm_merged_0" {
  name = "http4k-site-autowarm-merged-0"
...
resource "aws_lambda_function" "merged_0" {
  function_name = "http4k-site-merged-0"
  role = aws_iam_role.merged_0.arn
  s3_bucket = "eu.http4k-site.s3.ktls.aws.intellij.net"
  s3_key = "kotless-lambdas/http4k-site-merged-0.jar"
...
resource "aws_lambda_permission" "autowarm_merged_0" {
  statement_id = "http4k-site-autowarm-merged-0"
...
resource "aws_lambda_permission" "pages_dsl_events_get" {
  statement_id = "http4k-site-pages-dsl-events-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "pages_dsl_http_get" {
  statement_id = "http4k-site-pages-dsl-http-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "pages_dsl_lifecycle_get" {
  statement_id = "http4k-site-pages-dsl-lifecycle-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "pages_dsl_overview_get" {
  statement_id = "http4k-site-pages-dsl-overview-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "pages_dsl_permissions_get" {
  statement_id = "http4k-site-pages-dsl-permissions-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "pages_faq_get" {
  statement_id = "http4k-site-pages-faq-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "pages_introduction_get" {
  statement_id = "http4k-site-pages-introduction-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "pages_plugin_configuration_get" {
  statement_id = "http4k-site-pages-plugin-configuration-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "pages_plugin_extensions_get" {
  statement_id = "http4k-site-pages-plugin-extensions-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "pages_plugin_overview_get" {
  statement_id = "http4k-site-pages-plugin-overview-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "pages_plugin_tasks_get" {
  statement_id = "http4k-site-pages-plugin-tasks-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_route53_record" "http4k_site_kotless_io" {
...
resource "aws_s3_bucket_object" "eu_http4k_site_s3_ktls_aws_intellij_net_static_css_highlight_style_css" {
  bucket = "eu.http4k-site.s3.ktls.aws.intellij.net"
  key = "static/css/highlight-style.css"
  source = "{root}/http4k/site/src/main/resources/static/css/highlight-style.css"
  etag = filemd5("{root}/http4k/site/src/main/resources/static/css/highlight-style.css")
  content_type = "text/css"
}

resource "aws_s3_bucket_object" "eu_http4k_site_s3_ktls_aws_intellij_net_static_css_kotless_site_css" {
  bucket = "eu.http4k-site.s3.ktls.aws.intellij.net"
  key = "static/css/kotless-site.css"
  source = "{root}/http4k/site/src/main/resources/static/css/kotless-site.css"
  etag = filemd5("{root}/http4k/site/src/main/resources/static/css/kotless-site.css")
  content_type = "text/css"
}

resource "aws_s3_bucket_object" "eu_http4k_site_s3_ktls_aws_intellij_net_static_favicon_apng" {
  bucket = "eu.http4k-site.s3.ktls.aws.intellij.net"
  key = "static/favicon.apng"
  source = "{root}/http4k/site/src/main/resources/static/favicon.apng"
  etag = filemd5("{root}/http4k/site/src/main/resources/static/favicon.apng")
  content_type = "image/apng"
}

resource "aws_s3_bucket_object" "eu_http4k_site_s3_ktls_aws_intellij_net_static_js_highlight_pack_js" {
  bucket = "eu.http4k-site.s3.ktls.aws.intellij.net"
  key = "static/js/highlight.pack.js"
  source = "{root}/http4k/site/src/main/resources/static/js/highlight.pack.js"
  etag = filemd5("{root}/http4k/site/src/main/resources/static/js/highlight.pack.js")
  content_type = "application/javascript"
}

resource "aws_s3_bucket_object" "merged_0" {
  bucket = "eu.http4k-site.s3.ktls.aws.intellij.net"
  key = "kotless-lambdas/http4k-site-merged-0.jar"
...
data "aws_acm_certificate" "http4k_site_kotless_io" {
  provider = aws.us_east_1
  domain = "http4k.site.kotless.io"
  statuses = ["ISSUED"]
}
...
output "application_url" {
  value = "https://http4k.site.kotless.io"
}
