...
resource "aws_api_gateway_base_path_mapping" "shortener" {
  ...
  stage_name = aws_api_gateway_deployment.http4k_shortener.stage_name
  domain_name = "http4k.short.kotless.io"
}

resource "aws_api_gateway_deployment" "http4k_shortener" {
...
resource "aws_api_gateway_domain_name" "shortener" {
  domain_name = "http4k.short.kotless.io"
  certificate_arn = data.aws_acm_certificate.http4k_short_kotless_io.arn
}
...
resource "aws_api_gateway_integration" "css_shortener_css" {
  ...
  type = "AWS"
  uri = "arn:aws:apigateway:${data.aws_region.current.name}:s3:path/${aws_s3_bucket_object.eu_http4k_short_s3_ktls_aws_intellij_net_static_css_shortener_css.bucket}/${aws_s3_bucket_object.eu_http4k_short_s3_ktls_aws_intellij_net_static_css_shortener_css.key}"
...
resource "aws_api_gateway_integration" "favicon_apng" {
  ...
  integration_http_method = "GET"
  type = "AWS"
  uri = "arn:aws:apigateway:${data.aws_region.current.name}:s3:path/${aws_s3_bucket_object.eu_http4k_short_s3_ktls_aws_intellij_net_static_favicon_apng.bucket}/${aws_s3_bucket_object.eu_http4k_short_s3_ktls_aws_intellij_net_static_favicon_apng.key}"
  credentials = aws_iam_role.kotless_static_role.arn
}
...
resource "aws_api_gateway_integration" "js_shortener_js" {
  ...
  integration_http_method = "GET"
  type = "AWS"
  uri = "arn:aws:apigateway:${data.aws_region.current.name}:s3:path/${aws_s3_bucket_object.eu_http4k_short_s3_ktls_aws_intellij_net_static_js_shortener_js.bucket}/${aws_s3_bucket_object.eu_http4k_short_s3_ktls_aws_intellij_net_static_js_shortener_js.key}"
  credentials = aws_iam_role.kotless_static_role.arn
}
...
resource "aws_cloudwatch_event_rule" "autowarm_merged_0" {
  name = "http4k-short-autowarm-merged-0"
...
resource "aws_lambda_function" "merged_0" {
  function_name = "http4k-short-merged-0"
  role = aws_iam_role.merged_0.arn
  s3_bucket = "eu.http4k-short.s3.ktls.aws.intellij.net"
  s3_key = "kotless-lambdas/http4k-short-merged-0.jar"
...
resource "aws_lambda_permission" "autowarm_merged_0" {
  statement_id = "http4k-short-autowarm-merged-0"
...
resource "aws_lambda_permission" "r_get" {
  statement_id = "http4k-short-r-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_lambda_permission" "shorten_get" {
  statement_id = "http4k-short-shorten-get"
  action = "lambda:InvokeFunction"
  function_name = aws_lambda_function.merged_0.arn
  principal = "apigateway.amazonaws.com"
...
resource "aws_route53_record" "http4k_short_kotless_io" {
...
resource "aws_s3_bucket_object" "eu_http4k_short_s3_ktls_aws_intellij_net_static_css_shortener_css" {
  bucket = "eu.http4k-short.s3.ktls.aws.intellij.net"
  key = "static/css/shortener.css"
  source = "{root}/http4k/shortener/src/main/resources/static/css/shortener.css"
  etag = filemd5("{root}/http4k/shortener/src/main/resources/static/css/shortener.css")
  content_type = "text/css"
}

resource "aws_s3_bucket_object" "eu_http4k_short_s3_ktls_aws_intellij_net_static_favicon_apng" {
  bucket = "eu.http4k-short.s3.ktls.aws.intellij.net"
  key = "static/favicon.apng"
  source = "{root}/http4k/shortener/src/main/resources/static/favicon.apng"
  etag = filemd5("{root}/http4k/shortener/src/main/resources/static/favicon.apng")
  content_type = "image/apng"
}

resource "aws_s3_bucket_object" "eu_http4k_short_s3_ktls_aws_intellij_net_static_js_shortener_js" {
  bucket = "eu.http4k-short.s3.ktls.aws.intellij.net"
  key = "static/js/shortener.js"
  source = "{root}/http4k/shortener/src/main/resources/static/js/shortener.js"
  etag = filemd5("{root}/http4k/shortener/src/main/resources/static/js/shortener.js")
  content_type = "application/javascript"
}

resource "aws_s3_bucket_object" "merged_0" {
  bucket = "eu.http4k-short.s3.ktls.aws.intellij.net"
  key = "kotless-lambdas/http4k-short-merged-0.jar"
...
data "aws_acm_certificate" "http4k_short_kotless_io" {
  provider = aws.us_east_1
  domain = "http4k.short.kotless.io"
  statuses = ["ISSUED"]
}
...
data "aws_iam_policy_document" "merged_0" {
  statement {
    effect = "Allow"
    resources = ["arn:aws:dynamodb:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:table/http4k-short-url-table"]
...
output "application_url" {
  value = "https://http4k.short.kotless.io"
}
